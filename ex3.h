...
struct rpc_request
{
    ...
    /* Target Input buffer */
    int input_target_rkey;
    int input_target_length;
    uint64_t input_target_addr;

    /* Reference Input buffer */
    int input_reference_rkey;
    int input_reference_length;
    uint64_t input_reference_addr;
...
#define OUTSTANDING_REQUESTS (4*1024) //(8*1024)
...
public:
    ...
    virtual void set_input_images(uchar *images_target, uchar* images_reference, size_t bytes) = 0;
